...
| Priority News 表示上限 | 20件（4列×5行） | `components/intelligence/IntelligenceHub.tsx` |
| カテゴリ別アクセントカラー | AI & EQ & Tech `#3D7DD8` / Marketing `#E8913A` / Fashion `#E0709B` / Product `#43A377` | `components/intelligence/categoryColors.ts` |
